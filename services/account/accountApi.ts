...
export interface ProducerProfileRequest {
  ...
  // Professions: array of profession IDs managed by account service
...
export interface UserProfileResponse {
  ...
  installationYear?: number;
  employeesCount?: number;
  // Account service returns detailed profession objects (array)
...
export interface ProducerPublicProfileResponse {
  ...
  installationYear?: number;
  employeesCount?: number;
  // Professions list (array of profession objects)
  professions?: Profession[];
}

/**
 * Profession object returned by account service
 */
